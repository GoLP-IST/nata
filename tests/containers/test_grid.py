...
@pytest.mark.parametrize(
    ...
    [
        (5, [5]),
        (slice(5), np.arange(5)),
        (slice(5, 98), np.arange(5, 98)),
        (slice(6, 74, 4), np.arange(6, 74, 4)),
        (np.index_exp[5, :], [5]),
        (np.index_exp[5:98, :], np.arange(5, 98)),
        (np.index_exp[6:74:4, :], np.arange(6, 74, 4)),
        (np.index_exp[8, 12], [8]),
        (np.index_exp[8, 14:87], [8]),
        (np.index_exp[8, 3:64:3], [8]),
